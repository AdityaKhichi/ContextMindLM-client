        ...
        {projects.length === 0 ? (
          <div className="text-center py-20">
            {searchQuery ? (
              ...
              // No projects at all
              <div className="max-w-md mx-auto">
                <div className="w-20 h-20 bg-linear-to-br from-gray-800 to-gray-900 rounded-2xl mx-auto mb-6 flex items-center justify-center shadow-xl">
              ...
              {viewMode === "grid" ? (
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                  {projects.map((project) => (
                    ...
                    >
                      {/* Project Icon */}
                      <div className="w-12 h-12 bg-linear-to-br from-gray-700 to-gray-800 rounded-xl mb-4 flex items-center justify-center shadow-lg group-hover:shadow-xl transition-all duration-200">
                ...
                <div className="space-y-2">
                  {projects.map((project) => (
                    ...
                    >
                      {/* Icon */}
                      <div className="w-10 h-10 bg-linear-to-br from-gray-700 to-gray-800 rounded-lg flex items-center justify-center shrink-0">
                      ...
                      {/* Date */}
                      <div className="text-xs text-gray-500 shrink-0 self-start">
                        {new Date(project.created_at).toLocaleDateString()}
                      </div>
